...
const FamilySchema = new Schema({//creamos la constante familyschema para guardar los datos internos como plantilla para crear las familias de alimentos.
  ...
  idFamily: { type: Schema.Types.ObjectId, ref: "Family" },//en esta funcion refenciamos que idFamily entre en la tabla de familia.
  name: { type: String, required: true },//nombre de la familia de alimentos
  products: [{ type: Schema.Types.ObjectId, ref: "Product" }],//productos que entran dentro de cada familia enlazando con el modelo de productos en forma de a muchos
});
