...
cartsCtrl.allCarts = async (req, res) => {
  //funcion usada para traenos todos los carritos de compra
...
cartsCtrl.userCart = async (req, res) => {
  //función para el carro que esta usando el usuario en ese momento
...
cartsCtrl.updateCart = async (req, res) => {
  //funcion para actualizar el carrito de compra por si se quiere añadir mas cantidad de un producto en concreto
